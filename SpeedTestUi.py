...
class Ui_SpeedTest(object):
    def setupUi(self, SpeedTest):
        ...
        SpeedTest.resize(977, 625)
        self.centralwidget = QtWidgets.QWidget(SpeedTest)
        self.centralwidget.setObjectName("centralwidget")
        self.gif = QtWidgets.QLabel(self.centralwidget)
        self.gif.setGeometry(QtCore.QRect(-10, 0, 991, 621))
        self.gif.setText("")
        self.gif.setPixmap(QtGui.QPixmap("P:\\AI Asisstant\\Database\\Gui Material\\speedTest.gif"))
